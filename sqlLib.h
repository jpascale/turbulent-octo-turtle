...
void SQLaddShow(char * buffer, int showID, int time, int roomID, int movieID);
void SQLremoveShow(char * buffer, int movieID);

void SQLaddMovie(char * buffer, int movieID, int length, char * title, char * desc);
